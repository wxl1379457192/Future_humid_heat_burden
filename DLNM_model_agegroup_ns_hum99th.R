...
model_train = function(data,outdir){
  ...
  data$IHD = data$Heatday_99th-data$CHD_99th
  data$IHN = data$Heatnight_99th-data$CHN_99th
  data$IHA = data$Heatall_99th-data$CH_99th
  ...
  CDD = onebasis(data$CHD_99th,fun="strata",breaks=c(1,2,4))
  CDN = onebasis(data$CHN_99th,fun="strata",breaks=c(1,2,4))
  CDA = onebasis(data$CH_99th,fun="strata",breaks=c(1,2,4))
  ...
  saveRDS(model,paste0(outdir,"/stratamodel_win",data$window[1],"_",data$age[1],"_ns_hum99th.rds"))
  return(data)
}
for (i in c(10,14,30)){
    ...
    fwrite(k,paste0(outdir,"/Inputdata_win",data$window[1],"_99th.csv") )
  }